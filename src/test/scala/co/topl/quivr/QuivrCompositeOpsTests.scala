...
class QuivrCompositeOpsTests extends munit.FunSuite with MockHelpers {
  ...
  test("An and proposition must evaluate to true when both the verification of both proofs is true") {
    ...
    val signatureProposition1 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk1)))))
    val signatureProposition2 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk2)))))
  ...
  test("A threshold proposition must evaluate to true when the threshold is passed") {
    ...
    val signatureProposition1 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk1)))))
    val signatureProposition2 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk2)))))
    val signatureProposition3 = signatureProposer.propose("VerySecure",VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk3)))))
  ...
  test("A threshold proposition must evaluate to false when the threshold is not passed") {
    ...
    val signatureProposition2 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk2)))))
    val signatureProposition3 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk3)))))
    val signatureProposition4 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk4)))))
    val signatureProposition5 = signatureProposer.propose("VerySecure", VerificationKey(VerificationKey.Value.Ed25519(VerificationKey.Ed25519VerificationKey(ByteString.copyFrom(vk5)))))
